<template>
    ...
    <!--        </div>-->
    <div :class='(buttonList.type == "2" ? "cap-image-ad__image-nav" : "cap-image-ad__slide cap-image-ad__text-nav")'
         :style='"overflow-x:hidden; background-color:"+buttonList.backgroundcolor'>
        <div v-if="buttonList.type == '2'" v-for="(item,index)  in buttonList.carousels" :key="index"
             class="image-wrapper" :style="'width:'+ data.width+'%; margin-right: 0px;'">
            <a :href="item.url" class="cap-image-ad__link cap-image-ad__link--image-nav"
               :style="'color:'+buttonList.color">
                <div class="cap-image-ad__image">
